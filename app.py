...
<style>
    ...
    .stRadio { display: flex; justify-content: center !important; margin: 1rem 0 1.5rem 0 !important; }
    .stRadio > div { justify-content: center !important; }
    .stRadio [role="radiogroup"] { background: #f0f4f8 !important; border-radius: 12px !important; padding: 3px !important; display: flex !important; gap: 3px !important; width: auto !important; border: 1px solid #d0d8e0 !important; }
    .stRadio [role="radiogroup"] label { flex: 0 0 auto !important; padding: 0.4rem 1.8rem !important; border-radius: 9px !important; font-weight: 600 !important; font-size: 0.9rem !important; color: #5a7a9a !important; margin: 0 !important; }
    .stRadio [role="radiogroup"] input:checked ~ div { background: #1e3a5f !important; color: white !important; border-radius: 9px !important; }
</style>
